# -*- coding: utf-8 -*-
"""
orb_backtest_v6_01.py
======================
NQ 期货 5 分钟 ORB 日内策略 —— NautilusTrader 版本 (v6.01)

v6.01: 在 v6 基础上【去掉移动止损到保本】, 只保留:
...
其余与 v6 一致:
  ...
  - 回测年限: 全数据 2010-06-07 ~ 2026-08-28
...
用法: cd ORB_strategy && ../.venv/bin/python orb_backtes_v6_01.py
"""
...
if __name__ == "__main__":
    ...
    venue = Venue(VENUE)
    engine = BacktestEngine(config=BacktestEngineConfig(trader_id=TraderId("ORB-BT-00601")))
    engine.add_venue(
        venue=venue,
    ...
    create_tearsheet(engine, output_path="html_output/orb_report_v6_01.html", title="NQ 5min ORB v6.01 回测报告 (2010-2026 全数据, 10R止盈 + 无保本)")
    print("\n可视化报告已生成: html_output/orb_report_v6_01.html")
